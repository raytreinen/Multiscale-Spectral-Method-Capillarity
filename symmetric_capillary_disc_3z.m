...
%
% Compute capillary surfaces with a multi-scale approach
% with inclination angles psia at radius r = a and psib at radius r = b
%
% The output can be set to [R1, R2, R3, U1, U2, U3, Psi1, Psi2, Psi3, ell1, ell2, ell3] 
% to return the solution to the problem.  The default is set to merely plot the solution.
%
...
%
% If this file is used as a function, replace the first line with function 
% [R1, R2, R3, U1, U2, U3, Psi1, Psi2, Psi3, ell1, ell2, ell3, n, res_bvp] = symmetric_capillary_annular(a,b,psia_actual,psib_actual,kappa)
